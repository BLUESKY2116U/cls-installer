...
clear
echo "Salam Jumpa dari CYBER LION SQUAD" | lolcat
echo "Jawab:" ;read {$}
clear
figlet MR.G4N70XY | lolcat
echo "================| Dilarang Recode ^_^ | ===============" | lolcat
...
echo "_________|Installer C•L•S Tools|___________" | lolcat
echo "|________|_____________________|__________|" | lolcat     
echo "|__|     Thanks To CYBER LION SQUAD    |__|" | lolcat
echo "|__|===================================|__|" | lolcat
echo "|__|           •C•L•S Area•            |__|" | lolcat
echo "|__|===================================|__|" | lolcat
echo "|_________| Author: MR.G4N70XY  |_________|" | lolcat
...
echo "===========================================" | lolcat
echo " Tools Rusak/Gak Berfungsi? " | lolcat
echo " WA : +6281296645898 " | lolcat
echo " IG : @MR.G4N70XY_ " | lolcat
###################################################
# CTRL + C
###################################################
trap ctrl_c INT
ctrl_c() {
clear
echo $" Terima Kasih Telah Menggunakan Installer C•L•S Tools " | lolcat
echo ""
echo $" Sampai Jumpa ^_^ " | lolcat
sleep 1 
exit
}
...
echo "=============================" | lolcat
echo $"26.  Tools Hack Bank (Maintenance)";
echo "=============================" | lolcat
...
echo $"00.  Exit";
echo ""
echo -e "╭─Silahkan Masukkan Pilihan anda >" |lolcat
read -p "╰─#" pil;
...
13) git clone https://github.com/IndonesianSecurity/kkktp
cd kktp
php kkktp.php
cd /data/data/com.termux/files/home/kktp
php /data/data/com.termux/files/home/ktpkkgenerate/kktp.php
